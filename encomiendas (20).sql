...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-07-2021 a las 02:19:10
...
INSERT INTO `banco` (`idBanco`, `banco`, `idPais`, `ba_ciudad`, `ba_email`, `ba_tlf`, `ba_direccion`, `ba_codbanco`) VALUES
(4, 'Banco de Venezuela', 1, 'Maturin', 'bcv@gmail.com', '+587', 'Sede Maturin edo Monagas', 15),
(5, 'Banco Caroni', 2, 'Cumana', 'car@gmail.com', '+589696', 'Cumana Sucre', 20),
(7, 'MERCANTIL', 1, 'MATURIN', 'MERCANTIL@GMAIL.COM', '+58969', 'MATURIN', 12);
...
(6, 'HENRY CA', 1, 'maturin', 'maturin', 'maturin', '+589689633', 'HENRY@GMAIL.COM', '896', 'HENRY', '+58785', 'HENRY@GMAIL.COM', '+5896', 'HENRY@GMAIL.COM', 'HENRY', '+5896', 'HENRY@GMAIL.COM', '7-8', '78596', '2021-07-22', 5000, 'HENRY.COM', 20, 1, '1.00', '2.00', 1, 2, '1.18', '3785.00', '0.00', 1);
...
--
ALTER TABLE `banco`
  MODIFY `idBanco` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `identidad`
  MODIFY `idTipoIdentidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `pagador`
  MODIFY `idPagador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
