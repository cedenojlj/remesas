...
<div class="container">
    <div class="row d-flex mt-3 justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Agente o Corresponsal</h4>
                    <form action="pagadorData.php" method="post" id="frmPagador" class="row needs-validation" novalidate enctype="multipart/form-data">

                        <div class="col-12 col-md-4">
                            <label for="idPagadores" class="form-label">idPagador</label>
                            <input type="text" name="idPagador" id="idPagadores" class="form-control" readonly>
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pagador" class="form-label">Nombre</label>
                            <input type="text" name="pagador" id="pagador" class="form-control" required>
                        </div>
                        ...
                        <div class="col-12 col-md-12">
                            ...
                            <input type="text" name="pa_direccion" id="pa_direccion" class="form-control" required>
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pa_provincia" class="form-label">Provincia</label>
                            <input type="text" name="pa_provincia" id="pa_provincia" class="form-control" required>
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pa_ciudad" class="form-label">Ciudad</label>
                            <input type="text" name="pa_ciudad" id="pa_ciudad" class="form-control" required>
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pa_tlf" class="form-label">Telefono</label>
                            <input type="text" name="pa_tlf" id="pa_tlf" class="form-control" required>
                        </div>
                        <div class="col-12 col-md-4">
                            <label for="pa_email" class="form-label">Email</label>
                            <input type="email" name="pa_email" id="pa_email" class="form-control" required>
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pa_cp" class="form-label">Codigo Postal</label>
                            <input type="text" name="pa_cp" id="pa_cp" class="form-control" required>
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pa_Director" class="form-label">Director</label>
                            <input type="text" name="pa_Director" id="pa_Director" class="form-control">
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pa_tlfDirector" class="form-label">Tlf Director</label>
                            <input type="text" name="pa_tlfDirector" id="pa_tlfDirector" class="form-control">
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pa_emailDirector" class="form-label">Email Director</label>
                            <input type="email" name="pa_emailDirector" id="pa_emailDirector" class="form-control">
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pa_tlfEnvios" class="form-label">Tlf Envios</label>
                            <input type="text" name="pa_tlfEnvios" id="pa_tlfEnvios" class="form-control">
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pa_emailEnvios" class="form-label">Email Envios</label>
                            <input type="email" name="pa_emailEnvios" id="pa_emailEnvios" class="form-control">
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pa_GteContabilidad" class="form-label">GteContabilidad</label>
                            <input type="text" name="pa_GteContabilidad" id="pa_GteContabilidad" class="form-control">
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pa_tlfContabilidad" class="form-label">Tlf Contabilidad</label>
                            <input type="text" name="pa_tlfContabilidad" id="pa_tlfContabilidad" class="form-control">
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pa_emailContabilidad" class="form-label">Email Contabilidad</label>
                            <input type="email" name="pa_emailContabilidad" id="pa_emailContabilidad" class="form-control">
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pa_horarios" class="form-label">Horarios</label>
                            <input type="text" name="pa_horarios" id="pa_horarios" class="form-control">
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pa_contrato" class="form-label">Contrato</label>
                            <input type="text" name="pa_contrato" id="pa_contrato" class="form-control" required>
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pa_inicioOperaciones" class="form-label">Inicio Operaciones</label>
                            <input type="date" name="pa_inicioOperaciones" id="pa_inicioOperaciones" class="form-control" required>
                        </div>


                        <div class="col-12 col-md-4">
                            <label for="pa_limite" class="form-label">Limite</label>
                            <input type="number" step="0.01" name="pa_limite" id="pa_limite" class="form-control" required>
                        </div>
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" name="pa_web" id="pa_web" class="form-control">
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pa_conciliarCada" class="form-label">Conciliar Cada</label>
                            <input type="number" name="pa_conciliarCada" id="pa_conciliarCada" class="form-control" required>
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pa_comision" class="form-label">Comision</label>
                            <input type="number" step="0.01" name="pa_comision" id="pa_comision" class="form-control" required>
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pa_fijo" class="form-label">Fijo</label>
                            <input type="number" step="0.01" name="pa_fijo" id="pa_fijo" class="form-control" required>
                        </div>
                        ...
                        <!-- <div class="col-12 col-md-4">
                            ...
                            <input type="number" step="0.001" name="pa_tasa" id="pa_tasa" class="form-control" value="1.177"    required>
                        </div> -->

                        <div class="col-12 col-md-4">
                            <label for="pa_tipoCambio" class="form-label">Tipo de Cambio</label>
                            <input type="number" step="0.01" name="pa_tipoCambio" id="pa_tipoCambio" class="form-control" required>
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="pa_impuesto" class="form-label">Impuesto</label>
                            <input type="number" step="0.01" name="pa_impuesto" id="pa_impuesto" class="form-control" value=0 required>
                        </div>
                        ...
                        <input type="hidden" name="pa_tasa" id="pa_tasa" value="1.177">            
