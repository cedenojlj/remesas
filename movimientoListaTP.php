...
<div class="container">
    <div class="row d-flex mt-3">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Movimiento Listado con Tipo de Cambio</h4>
                <form action="" method="post" id="frmMovimientoListaTP" class="row needs-validation" novalidate enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="accion" id="accion" value="10">
                ...
                <table id="movimiento_tablaTP" class="table table-bordered table-striped mt-5">
                    <thead>
                        <tr>
                            <th>id</th>
                            <th>Fecha</th>
