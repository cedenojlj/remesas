...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-04-2021 a las 00:32:31
...
(1, 'jose', 'cedeno', '1979-01-12', 1, 'monagas', 'maturin', 'maturin edo monagas', '+587896', 'jose@gmail.com', '785896', 1, '2021-04-14', '2021-04-24', 'venezolano', 'jose', '+5967996', '+58966896', 125636652, 2, 1, 'diagrama.bmp', '', ''),
(4, 'illeny', 'bermudez', '2021-03-01', 1, 'maturin', 'maturin', 'maturin edo monagas', '+5896', 'illeny@gmail.com', '14256', 1, '2021-03-29', '2021-04-30', 'venezolano', 'illeny', '+5896', '+58996', 5000, 3, 1, 'pcb.jpg', '', ''),
(5, 'Andres', 'Villalobos', '2021-03-09', 1, 'caracas', 'caracas', 'caracas venezuela', '+5885', 'andres@gmail.com', '45896', 2, '2021-04-20', '2021-04-25', 'venezolano', 'andres', '+5896', '+5896', 452896, 4, 2, 'diagrama.PNG', 'm_user.PNG', 'tablas.PNG');
...
INSERT INTO `movimiento` (`idMovimiento`, `fechaOperacion`, `numOperacion`, `idCuenta`, `entrada`, `salida`, `idUsuario`, `creacion`) VALUES
(1, '2021-04-21', 2147483647, 1, '2000.00', '8.45', 14, '2021-04-21 21:11:45'),
(90, '2021-04-21', 123456700, 1, '1.78', '8.45', 14, '2021-04-21 15:33:48'),
(91, '2021-04-22', 123456701, 1, '1.79', '8.46', 14, '2021-04-21 15:33:48'),
(92, '2021-04-23', 123456702, 1, '2.50', '8.47', 14, '2021-04-21 21:04:29'),
(93, '2021-04-24', 123456703, 1, '10.23', '8.48', 14, '2021-04-21 21:14:58'),
(94, '2021-04-25', 123456704, 1, '1.82', '8.49', 14, '2021-04-21 15:33:48'),
(95, '2021-04-26', 123456705, 1, '1.83', '8.50', 14, '2021-04-21 15:33:48'),
(96, '2021-04-27', 123456706, 1, '1.84', '8.51', 14, '2021-04-21 15:33:48'),
(97, '2021-04-28', 123456707, 1, '1.85', '8.52', 14, '2021-04-21 15:33:49'),
(98, '2021-04-29', 123456708, 1, '1.86', '8.53', 14, '2021-04-21 15:33:49'),
(99, '2021-04-30', 123456709, 1, '1.87', '8.54', 14, '2021-04-21 15:33:49'),
(100, '2021-04-21', 74896, 3, '1545.45', '0.00', 14, '2021-04-22 20:53:46');
...
(3, 'Agentejose', 1, 'Monagas', 'Maturin', 'Maturin edo Monagas', '+589696', 'agjose@gmail.com', '58969', 'jose', '+596', 'jose@gmail.com', '+58963', 'jose@gmail.com', 'pedro', '+5896', 'pedro@gmail.com', '7 a 8 am y 2 a 6 pm', '74896', '2021-04-19', 5000, 'www.jose.com', 30, 1, '5.31', '2.12', 1, 1, '1.35', '2450.45', '16.43', 1),
(4, 'Pagadorjose', 2, 'Quito', 'Quito', 'Quito', '+589', 'pagjose@gmail.com', '78596', 'pajose', '+5896', 'pagjose@gmail.com', '+5896', 'pagjose@gmail.com', 'jose', '+59963', 'pagjose@gmail.com', '7 a 8 am y 2 a 6 pm', '748596', '2021-04-19', 7851, 'www.pajose.com', 30, 2, '4.78', '1.00', 3, 2, '1.23', '2123.45', '16.12', 2);
...
(14, 'jose', 'cedeno', 'maturin', '+589639', 'cedeno@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', '125896', 'maturin', 3, 1, 1),
(15, 'pedro', 'perez', 'maturin', '+589639', 'perez@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', '125896', 'maturin', 4, 1, 1);
...
--
ALTER TABLE `estadogiro`
  MODIFY `idEstadoGiro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `giro`
--
ALTER TABLE `giro`
  MODIFY `idGiro` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `monedaenvio`
  MODIFY `idMonedaEnvio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `movimiento`
--
ALTER TABLE `movimiento`
  MODIFY `idMovimiento` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;
